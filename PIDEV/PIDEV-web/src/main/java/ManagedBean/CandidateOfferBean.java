...
public class CandidateOfferBean implements Serializable {
	...
	public String shoicetheQuiz(CandidateOffer l) {
		...
		System.out.println(l.getAspNetUser()+"tttttttttttttttt");
	...
	public String AffectQuiz(Evaluationtest evaluationtest)
	{
		...
		System.out.println(evaluationtest.getEtId()+"hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
		System.out.println(idChosen+"jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj");
