...
public class Evaluationguestaffectation implements Serializable {
	...
	@Column(name="StausofQuiz")
	private String stausofQuiz;
	...
	public String getStausofQuiz() {
		return stausofQuiz;
	}

	public void setStausofQuiz(String stausofQuiz) {
		this.stausofQuiz = stausofQuiz;
	}
